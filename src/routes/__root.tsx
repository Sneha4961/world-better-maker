  ...
  head: () => ({
    meta: [
      ...
      { title: "Drishti AI — See it. Hear it. Understand it." },
      {
        name: "description",
        content:
          "Photograph any sign, prescription or menu — Drishti AI explains it in plain language and reads it aloud.",
      },
      { name: "author", content: "Drishti AI" },
      { property: "og:title", content: "Drishti AI — See it. Hear it. Understand it." },
      {
        property: "og:description",
        content:
          "Point your camera at the world. Drishti explains it in plain language and reads it aloud.",
      },
